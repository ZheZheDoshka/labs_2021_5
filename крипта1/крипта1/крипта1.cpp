...
int main()
{
	...
	for (char c; text32.get(c); text2.put(c))
	{
		...
		for (int i = 0; i < 34; i++)
		{
			if ((c == m[i]) || (c == M[i]))
			{
				if (b1 * i != 1089) //проверка не два пробела ли подряд, 33*33
				{
					d1[b1][i]++;
					d1t++;
				}
	...
	for (int i = 0; i < 33; i++) {
		...
		for (int j = 0; j < 33; j++)
		{
			stroka = stroka + to_string(p2i[i][j]) + ";";
		}
		stroka = stroka + "\n";
		file4 << stroka;
		stroka = " ";
	...
	for (int i = 0; i < 34; i++) {
		...
		for (int j = 0; j < 34; j++)
		{
			stroka = stroka + to_string(p1i[i][j]) + ";";
		}
		stroka = stroka + "\n";
		file4 << stroka;
		stroka = " ";
	...
	for (int i = 0; i < 33; i++) {
		...
		for (int j = 0; j < 33; j++)
		{
			stroka = stroka + to_string(p2[i][j]) + ";";
		}
		stroka = stroka + "\n";
		file4 << stroka;
		stroka = " ";
	...
	for (int i = 0; i < 34; i++) {
		...
		for (int j = 0; j < 34; j++)
		{
			stroka = stroka + to_string(p1[i][j]) + ";";
		}
		stroka = stroka + "\n";
		file4 << stroka;
		stroka = " ";
	}
	file4 << "Odinarna bez probelov\n";
	file4 << abc;
	stroka = " ;";
	for (int i = 0; i < 33; i++)
		{
			stroka = stroka + to_string(pi[i]) + ";";
		}
		stroka = stroka + "\n";
		file4 << stroka;
		stroka = " ;";
	file4 << "Odinarna s probelami\n";
	file4 << abc;
	stroka = " ;";
	for (int i = 0; i < 34; i++) 
		{
			stroka = stroka + to_string(pi_[i]) + ";";
		}
		stroka = stroka + "\n";
		file4 << stroka;
		stroka = " ;";
